...
if (isset($_POST['add'])) {
    ...
    $alamat = $_POST['alamat'];
    $telp = $_POST['telp'];
    mysqli_query($conn, "INSERT INTO pasien (nama, alamat, telp) VALUES ('$nama', '$alamat', '$telp')");
...
if (isset($_POST['update'])) {
    ...
    $alamat = $_POST['alamat'];
    $telp = $_POST['telp'];
    mysqli_query($conn, "UPDATE pasien SET nama='$nama', alamat='$alamat', telp='$telp' WHERE id=$id");
    header("Location: pasien.php");
}
